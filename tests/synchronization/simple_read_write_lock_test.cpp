...
class SimpleReadWriteLockTest : public ::testing::Test {
 protected:
...
TEST_F(SimpleReadWriteLockTest, BasicFunctionality) {
...
TEST_F(SimpleReadWriteLockTest, MultipleReaders) {
...
TEST_F(SimpleReadWriteLockTest, ExclusiveWriter) {
...
TEST_F(SimpleReadWriteLockTest, WriterBlocksReaders) {
...
TEST_F(SimpleReadWriteLockTest, ReadersBlockWriter) {
  constexpr size_t kNumReaders = 5;
...
TEST_F(SimpleReadWriteLockTest, AlternatingReadersWriters) {
